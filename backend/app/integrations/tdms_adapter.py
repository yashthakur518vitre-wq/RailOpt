...
class TrackDefectManagementAdapter(BaseRailwayAdapter):
    """Mock adapter for Track Defect Management System (TDMS)."""
    def __init__(self):
    ...
    def fetch_defects(self) -> list[dict]:
        csv_path = os.path.join(self.data_dir, "sample_defects.csv")
